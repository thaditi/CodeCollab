...
import localClasses from "./CollabEditor.module.css";
import {
  languages,
  defaultValue,
  langMode,
  ...
  const handleCodeRun = async () => {
    ...
    let options = {
      ...
      headers: {
        ...
        "x-rapidapi-key": "2b9ef2b24dmsh3053fbecd6b87e8p1120e3jsndf65bbbb9529",
    ...
    <Fragment>
        ...
        <div className={localClasses.loader}>
          <div>
            <span style={{ paddingLeft: "190px" }}>
              <FiberManualRecordIcon style={{ fontSize: "105px" }} />
            </span>
            <span>
              <FiberManualRecordOutlinedIcon style={{ fontSize: "105px" }} />
            </span>
          </div>
        </div>
      </Dialog>
      ...
      <AppBar position="static" style={{ backgroundColor: "#000A29" }}>
        <div className={`${localClasses.Editor__navbar} row`}>
          ...
          >
            &nbsp;Collab<span style={{ color: "#f99e26" }}>Editor</span>
          </Typography>
          <Toolbar>
            <FormControl
              size="small"
            ...
            >
              <InputLabel
                id="mode-label"
                style={{ fontFamily: "poppins", color: "#f99e26" }}
              >
                Language
              </InputLabel>
              <Select
